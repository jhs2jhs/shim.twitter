# Django settings for s_twitter project.
...
DATABASES = {
    'default': {
        ...
        'NAME': 's_twitter.sql',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'paey!*z1=3%fe1^yxufxk@6@)_2@j#9-p+y3&f-l1wf!ub*s81'
